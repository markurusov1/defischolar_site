...
{{% hint info %}}
- In traditional finance, banks maintain private paperwork to track your balance; in blockchain, this is replaced by 
a **Distributed Ledger**.
- **Transparency**: Everyone on the network can see all transactions.
- **Immutability**: The technology ensures that once a transaction is recorded, it is "immutable"—it cannot be hacked,
